...
def get_stock_data(ticker, start_date, end_date):
    # pulling out the needed data from yahoo finance data bank
    ...
    # this calculates sum of daily returns of the stock and puts them in log function to get rid of multiplication
...
#variance measures how "spread out" the jumps are from the average in the absolute value
